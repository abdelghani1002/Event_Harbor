        ...
        <div class="container mx-auto flex px-5 py-12 md:flex-row flex-col items-center ">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="flex justify-between dark:text-gray-100">
                        ...
                        <span class="font-bold m-0 p-1 text-2xl">
                            {{ $event->ticket_price }}<strong class="p-1">$</strong>
                        </span>
                    </div>
                ...
                <div class="flex justify-between w-full bottom-0">
                    ...
                    @if ($event->organizer->id == auth()->id())
                        <span
                            ...
                            <strong class="mr-2 text-xl">{{ $event->tickets_booked }} </strong>tickets sold
                        </span>
                    ...
                    @else
                        <form method="post" action="{{ route('reserve', $event) }}">
                            @csrf
                            @method('POST')
                            <button
            ...
            <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                <img class="object-cover object-center rounded" alt="hero"
                    src="{{ asset('storage/photos/' . $event->photo_src) }}">
            </div>
        </div>
    </section>
